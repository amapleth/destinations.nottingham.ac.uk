...
$postcodes = array(
	...
	'East Sussex'	=> array(
		'sql'	=> "(LOCEMP LIKE 'BN50%' OR LOCEMP LIKE 'BN51%' OR LOCEMP LIKE 'BN52%') OR (LOCEMP LIKE 'BN_%' AND LOCEMP LIKE 'BN6%' AND LOCEMP NOT LIKE 'BN11%' AND LOCEMP NOT LIKE 'BN12%' AND LOCEMP NOT LIKE 'BN13%' AND LOCEMP NOT LIKE 'BN14%' AND LOCEMP NOT LIKE 'BN15%' AND LOCEMP NOT LIKE 'BN16%' AND LOCEMP NOT LIKE 'BN17%' AND LOCEMP NOT LIKE 'BN18%' AND LOCEMP NOT LIKE 'BN42%' AND LOCEMP NOT LIKE 'BN43%' AND LOCEMP NOT LIKE 'BN44%' AND LOCEMP NOT LIKE 'BN45%' AND LOCEMP NOT LIKE 'BN99%') OR LOCEMP LIKE 'TN5%' OR LOCEMP LIKE 'TN6%' OR LOCEMP LIKE 'TN7%' OR LOCEMP LIKE 'TN19%' OR LOCEMP LIKE 'TN20%' OR LOCEMP LIKE 'TN21%' OR LOCEMP LIKE 'TN22%' OR LOCEMP LIKE 'TN31%' OR LOCEMP LIKE 'TN32%' OR LOCEMP LIKE 'TN33%' OR LOCEMP LIKE 'TN34%' OR LOCEMP LIKE 'TN35%' OR LOCEMP LIKE 'TN36%' OR LOCEMP LIKE 'TN37%' OR LOCEMP LIKE 'TN38%' OR LOCEMP LIKE 'TN39%' OR LOCEMP LIKE 'TN40%'"
	),
	'Hampshire'	=> array(
	...
	'North Yorkshire (Yorks. part)'	=> array(
		'sql'	=> "LOCEMP LIKE 'BD23%' OR LOCEMP LIKE 'BD24%' OR LOCEMP LIKE 'DL6%' OR LOCEMP LIKE 'DL7%' OR LOCEMP LIKE 'DL8%' OR LOCEMP LIKE 'DL9%' OR LOCEMP LIKE 'DL10%' OR LOCEMP LIKE 'DL11%' OR (LOCEMP LIKE 'YO_%' AND LOCEMP NOT LIKE 'YO15%' AND LOCEMP NOT LIKE 'YO16%' AND LOCEMP NOT LIKE 'YO25%' AND LOCEMP NOT LIKE 'YO41%' AND LOCEMP NOT LIKE 'YO42%' AND LOCEMP NOT LIKE 'YO43%')"
	),
	'South Yorkshire'	=> array(
		'sql'	=>"(LOCEMP REGEXP '^S[0-9]+' AND LOCEMP NOT LIKE 'S18%' AND LOCEMP NOT LIKE 'S21%' AND LOCEMP NOT LIKE 'S32%' AND LOCEMP NOT LIKE 'S33%' AND LOCEMP NOT LIKE 'S40%' AND LOCEMP NOT LIKE 'S41%' AND LOCEMP NOT LIKE 'S42%' AND LOCEMP NOT LIKE 'S43%' AND LOCEMP NOT LIKE 'S44%' AND LOCEMP NOT LIKE 'S45%' AND LOCEMP NOT LIKE 'S49%' AND LOCEMP NOT LIKE 'S80%' AND LOCEMP LIKE 'S81%') OR (LOCEMP LIKE 'DN_%' AND LOCEMP NOT LIKE 'DN15%' AND LOCEMP NOT LIKE 'DN16%' AND LOCEMP NOT LIKE 'DN17%' AND LOCEMP NOT LIKE 'DN18%' AND LOCEMP NOT LIKE 'DN19%' AND LOCEMP NOT LIKE 'DN20%' AND LOCEMP NOT LIKE 'DN31%' AND LOCEMP NOT LIKE 'DN32%' AND LOCEMP NOT LIKE 'DN33%' AND LOCEMP NOT LIKE 'DN34%' AND LOCEMP NOT LIKE 'DN35%' AND LOCEMP NOT LIKE 'DN37%' AND LOCEMP NOT LIKE 'DN38%' AND LOCEMP NOT LIKE 'DN39%' AND LOCEMP NOT LIKE 'DN40%' AND LOCEMP NOT LIKE 'DN41%' AND LOCEMP NOT LIKE 'DN10%' AND LOCEMP NOT LIKE 'DN11%' AND LOCEMP NOT LIKE 'DN22%' AND LOCEMP NOT LIKE 'DN14%' AND LOCEMP NOT LIKE 'DN21%' AND LOCEMP NOT LIKE 'DN36%')"
		),
