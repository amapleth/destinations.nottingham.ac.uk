...
LOAD DATA INFILE '/usr/local/lib/gems/docs/uon_specific/import7/extract0708.txt' INTO TABLE extract78 FIELDS TERMINATED BY '\t';
LOAD DATA INFILE '/usr/local/lib/gems/docs/uon_specific/import7/extract0809.txt' INTO TABLE extract89 FIELDS TERMINATED BY '\t';
LOAD DATA INFILE '/usr/local/lib/gems/docs/uon_specific/import7/extract0910.txt' INTO TABLE extract910 FIELDS TERMINATED BY '\t';
SELECT count(*) as extract78 from extract78;
SELECT count(*) as extract89 from extract89;
SELECT count(*) as extract910 from extract910;
EOFMYSQL
