...
$countsa = $apa + $bpa + $cpa + $epa + $fpa + $gpa + $opa + $spa;
$countsb = $apb + $bpb + $cpb + $epb + $fpb + $gpb + $opb + $spb;
$countsc = $apc + $bpc + $cpc + $epc + $fpc + $gpc + $opc + $spc;
$countsd = $apd + $bpd + $cpd + $epd + $fpd + $gpd + $opd + $spd;
