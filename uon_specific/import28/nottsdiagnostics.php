...
$count = mysql_num_rows( mysql_query("SELECT COUNT(*) FROM popdlhe78 WHERE HOMEEU = '3'") );
echo "<p>7/8: $count</p>";

$count = mysql_num_rows( mysql_query("SELECT COUNT(*) FROM popdlhe89 WHERE HOMEEU = '3'") );
echo "<p>8/9: $count</p>";

$count = mysql_num_rows( mysql_query("SELECT COUNT(*) FROM popdlhe910 WHERE HOMEEU = '3'") );
echo "<p>9/10: $count</p>";

$count = mysql_num_rows( mysql_query("SELECT COUNT(*) FROM popdlhe1011 WHERE HOMEEU = '3'") );
