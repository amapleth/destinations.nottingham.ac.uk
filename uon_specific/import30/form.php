...
$mysqlhomeeu5="SELECT XQMODE01 FROM popdlhe78 WHERE HOMEEU = '3' AND (SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' AND LEV1 LIKE '".$h."' AND LEV2 LIKE '".$i."' AND LEV3 LIKE '".$j."') UNION ALL SELECT XQMODE01 FROM popdlhe89 WHERE HOMEEU = '3' AND (SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' AND LEV1 LIKE '".$h."' AND LEV2 LIKE '".$i."' AND LEV3 LIKE '".$j."') UNION ALL SELECT XQMODE01 FROM popdlhe910 WHERE HOMEEU = '3' AND (SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' AND LEV1 LIKE '".$h."' AND LEV2 LIKE '".$i."' AND LEV3 LIKE '".$j."') UNION ALL SELECT XQMODE01 FROM popdlhe1011 WHERE HOMEEU = '3' AND (SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' AND LEV1 LIKE '".$h."' AND LEV2 LIKE '".$i."' AND LEV3 LIKE '".$j."')";
...
$mysqlhomeeu5="SELECT XQMODE01 FROM popdlhe78 WHERE HOMEEU = '3' AND (SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' UNION ALL SELECT HUSID, HOMEEU, XQMODE01, QUAL1 FROM popdlhe910 WHERE SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' UNION ALL SELECT HUSID, HOMEEU, XQMODE01, QUAL1 FROM popdlhe1011 WHERE SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."') UNION ALL SELECT XQMODE01 FROM popdlhe89 WHERE HOMEEU = '3' AND (SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' UNION ALL SELECT HUSID, HOMEEU, XQMODE01, QUAL1 FROM popdlhe910 WHERE SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' UNION ALL SELECT HUSID, HOMEEU, XQMODE01, QUAL1 FROM popdlhe1011 WHERE SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."') UNION ALL SELECT XQMODE01 FROM popdlhe910 WHERE HOMEEU = '3' AND (SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' UNION ALL SELECT HUSID, HOMEEU, XQMODE01, QUAL1 FROM popdlhe910 WHERE SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' UNION ALL SELECT HUSID, HOMEEU, XQMODE01, QUAL1 FROM popdlhe1011 WHERE SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."') UNION ALL SELECT XQMODE01 FROM popdlhe1011 WHERE HOMEEU = '3' AND (SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' UNION ALL SELECT HUSID, HOMEEU, XQMODE01, QUAL1 FROM popdlhe910 WHERE SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."' UNION ALL SELECT HUSID, HOMEEU, XQMODE01, QUAL1 FROM popdlhe1011 WHERE SCHOOL LIKE '".$e."' AND SUBJECT LIKE '".$f."' AND COURSE LIKE '".$g."')";
...
# movingg the statement line below up into the conditionals for the mysql for radio buttons about line 500
...
echo "<input type='hidden' name='lev3' value='$j' /><input type='hidden' name='surveyb' value='$surveyb' /><input type='hidden' name='pageid' value='$id' /></td></tr><tr><td colspan='5'><hr /></td></tr><tr><td colspan='6'><p class='small'>*Number in (brackets) is the number of graduates in the survey population over the last four years</p></td></tr></table>";
