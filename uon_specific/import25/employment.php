...
$countsa = $apa + $bpa + $cpa + $epa + $fpa + $gpa + $opa + $spa + $xpa;
$countsb = $apb + $bpb + $cpb + $epb + $fpb + $gpb + $opb + $spb + $xpb;
$countsc = $apc + $bpc + $cpc + $epc + $fpc + $gpc + $opc + $spc + $xpc;
$countsd = $apd + $bpd + $cpd + $epd + $fpd + $gpd + $opd + $spd + $xpd;
...
/*echo "2007/08 data:<br />";
echo "Number of A's: $apa<br />";
echo "Number of B's: $bpa<br />";
echo "Number of C's: $cpa<br />";
echo "Number of D's: $dpa <--(Should be no value here)<br />";
echo "Number of E's: $epa<br />";
echo "Number of F's: $fpa<br />";
echo "Number of G's: $gpa<br />";
echo "Number of O's: $opa<br />";
echo "Number of S's: $spa<br />";
echo "Number of UK Y's: $ypa1<br />";
echo "Number of EU Y's: $ypa2<br />";
echo "Number of Int Y's: $ypa3<br />";
echo "Number of Unassigned: $zpa <--(Should be no value here)<br />";
echo "Total in initial query: $smallra <--(Should be total matching population)<br />";
echo "Total used for PO denominator: $positivea<br />";
echo "Total used for PO numerator: $positive3a<br />";
echo "Total used for percentage column: $percentpa <--(Should be A - Y total)<br />";*/
...
if ($d=="%" || $d=='6') $smallra1=mysql_num_rows(mysql_query("select distinct HUSID from popdlhe78 where XQMODE01 like '".$e."' and " . $level . " and " . $levela . " and ".$homeeu." $courseselecta"));
else $smallra=='0';
if ($d=="%" || $d=='1' || $d=='5') $smallrb1=mysql_num_rows(mysql_query("select distinct HUSID from popdlhe89 where XQMODE01 like '".$e."' and " . $level . " and " . $levela . " and ".$homeeu." $courseselectb"));
else $smallrb=='0';
if ($d=="%" || $d=='1' || $d=='2' || $d=='4') $smallrc1=mysql_num_rows(mysql_query("select distinct HUSID from popdlhe910 where XQMODE01 like '".$e."' and " . $level . " and " . $levela . " and ".$homeeu." $courseselectc"));
else $smallrc=='0';
if ($d=="%" || $d=='1' || $d=='2' || $d=='3') $smallrd1=mysql_num_rows(mysql_query("select distinct HUSID from popdlhe1011 where XQMODE01 like '".$e."' and " . $level . " and " . $levela . " and ".$homeeu." $courseselectd"));
else $smallrd=='0';

if ($smallra1=="") $smallra1='0'; if ($smallrb1=="") $smallrb1='0'; if ($smallrc1=="") $smallrc1='0'; if ($smallrd1=="") $smallrd1='0';
